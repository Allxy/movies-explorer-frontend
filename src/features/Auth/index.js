...
function Auth({ title, button, children, link }) {
  return (
    <Flex direction="column" component="main" className={styles.auth}>
      ...
      <Flex component="form" direction="column" className={styles.auth__form}>
        {children}
        <Button variant="blue" className={styles.auth__submit}>
          {button}
        </Button>
